 ...
 */
export function assertAllowedLawPublicBaseUrl(rawUrl) {
    let parsed;
    try {
    ...
    if (!ALLOWED_PUBLIC_HOSTS.has(parsed.hostname)) {
        throw new Error(`[Law] Public base URL host not allowed: ${parsed.hostname}. ` +
            "Only law.jexxx.us (or localhost for dev) is permitted.");
    }
    return rawUrl.replace(/\/$/, "");
}
//# sourceMappingURL=law-security.js.map
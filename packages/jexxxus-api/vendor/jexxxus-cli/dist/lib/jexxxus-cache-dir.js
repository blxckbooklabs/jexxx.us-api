...
export function resolveJexxxusDir() {
...
export function ensureJexxxusDir(dir = resolveJexxxusDir()) {
    try {
...
export function jexxxusFile(...segments) {
    return path.join(resolveJexxxusDir(), ...segments);
}
//# sourceMappingURL=jexxxus-cache-dir.js.map
 ...
 */
export function assertAllowedVeilPublicBaseUrl(rawUrl) {
    let parsed;
    try {
    ...
    if (!ALLOWED_PUBLIC_HOSTS.has(parsed.hostname)) {
        throw new Error(`[VEIL] Public base URL host not allowed: ${parsed.hostname}. ` +
...
export function readPublicMarkdownFile(dir, filename) {
...
export function assertSafeArticlePostsDir(postsDir) {
...
//# sourceMappingURL=veil-security.js.map
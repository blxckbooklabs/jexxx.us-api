...
export const MUSIC_CATALOG = [
    {
        ...
        description: "Christian hip-hop beats and gospel rap production from Memphis, TN. Garden home base for JEXXXUS Music.",
        category: "page",
    ...
    },
    {
        ...
        description: "Lease or exclusive Christian hip-hop instrumentals. Traktrain-embedded beat store on music.jexxx.us.",
        category: "beats",
    ...
    },
    {
        ...
        description: "Gospel rap production kits — drum kits, melody loops, and sound design tools.",
        category: "kits",
    ...
    },
    {
        ...
        description: "Independent Memphis label — electronic, experimental, hip-hop, ambient. Masters retained by artists.",
        category: "label",
    ...
    },
    {
        slug: "song-of-dylan",
        title: "Song of Dylan",
        description: "Solo electronic/ambient/experimental project — Notion hub, Linktree, SoundCloud.",
        category: "artist",
    ...
    },
    {
        ...
        description: "Architecture and garden context for Crucifly Records, Song of Dylan, and music × technology.",
        category: "docs",
...
export function listMusicCatalog(limit = 25) {
    return MUSIC_CATALOG.slice(0, Math.min(Math.max(1, limit), MUSIC_CATALOG.length));
}
export function getMusicEntry(slugOrQuery) {
...
export function searchMusicCatalog(query, limit = 10) {
    const q = query.toLowerCase().trim();
    if (!q)
        return listMusicCatalog(limit);
    const scored = MUSIC_CATALOG.map((entry) => {
        const haystack = [
            ...
            .toLowerCase();
        let score = 0;
        if (entry.slug.includes(q) || entry.title.toLowerCase().includes(q))
            score += 10;
...
export async function fetchMusicLlmsTxt() {
    const now = Date.now();
...
export function getMusicDocsSummary() {
    return [

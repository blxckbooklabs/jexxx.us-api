 ...
 */
function resolvePath(envVar, hint) {
 ...
 */
export function resolveBibleVaultPath() {
 ...
 */
export function resolveVeilRepoPath() {
 ...
 */
export function resolveVeilArticlesPath() {
    return (resolvePath("JEXXXUS_VEIL_ARTICLES_PATH", "VEIL articles") ??
 ...
 */
export function resolveTvRepoPath() {
 ...
 */
export function resolveObsidianPersonasPath() {
 ...
 */
export function validateVaultPath(basePath, requestedPath) {

 ...
 */
export declare function createUserSupabaseClient(env: UserEnv, getAccessToken: () => Promise<string>, target?: DashboardTarget): SupabaseClient;
//# sourceMappingURL=user-supabase.d.ts.map
import { getTvContentSourceInfo, getTvPublicEndpoints, getTvVideo, getTvVideoMeta, listTvCategories, listTvVideos, searchTvVideos, } from "../../tv.js";
import { recommendTvVideos } from "../../tv-algorithm.js";
import { formatTvDiscover, formatTvVideoFull, formatTvVideoList, formatTvVideoMeta, } from "./tv-format.js";
function resolveTvAction(raw) {
...
export const tvTool = {
    name: "tv_query",
    description: "Query public JEXXXUS | TV videos on tv.jexxx.us (official videos.json or public llms-full/RSS only). " +
    ...
    async execute(args) {
        ...
        switch (action) {
            case "discover": {
                return formatTvDiscover(endpoints, allVideos.length, allVideos.slice(0, 5), categories, sourceInfo);
            }
            case "list": {
            ...
            case "meta": {
                ...
                if (!meta)
                    return `No JEXXXUS | TV video found matching "${key}".`;
...
//# sourceMappingURL=tv-tools.js.map
import { getVeilArticle, getVeilArticleMeta, getVeilContentSourceInfo, getVeilPublicEndpoints, listVeilArticles, searchVeilArticles, } from "../../veil.js";
import { formatVeilArticleFull, formatVeilArticleList, formatVeilArticleMeta, formatVeilDiscover, } from "./veil-format.js";
function resolveVeilAction(raw) {
 ...
 */
export const veilTool = {
    name: "veil_query",
    description: "Query public VEIL articles on veil.jexxx.us (official repo content/posts or public RSS only). " +
    ...
    async execute(args) {
        ...
        switch (action) {
            ...
            case "meta": {
                ...
                if (!meta)
                    return `No VEIL article found matching "${key}".`;
...
//# sourceMappingURL=veil-tools.js.map
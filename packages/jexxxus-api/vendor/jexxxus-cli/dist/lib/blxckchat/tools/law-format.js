...
export function formatLawPolicyList(policies, total) {
...
export function formatLawPolicyMeta(meta, endpoints) {
...
export function formatLawDiscover(endpoints, policyCount, samples) {
    const lines = [
...
export function formatLawPolicyFull(policy) {
    const header = [
        policy.title,
        `URL: ${policy.url}`,
...
//# sourceMappingURL=law-format.js.map
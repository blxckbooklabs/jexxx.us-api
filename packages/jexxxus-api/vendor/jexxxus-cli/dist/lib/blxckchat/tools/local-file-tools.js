...
const MANAGED_SUBDIRS = ["exports", "imports", "workspace"];
...
function isInsideManagedRoot(resolved) {
...
export const readLocalFileTool = {
    ...
    description: "Read a local file's contents. Relative paths resolve inside " +
...
export const writeLocalFileTool = {
    ...
    description: "Write (create or overwrite) a local file with the given content. Relative " +
...
export const editLocalFileTool = {
    name: "edit_local_file",
    description: "Apply an exact text replacement inside an existing local file — oldText " +
...
//# sourceMappingURL=local-file-tools.js.map
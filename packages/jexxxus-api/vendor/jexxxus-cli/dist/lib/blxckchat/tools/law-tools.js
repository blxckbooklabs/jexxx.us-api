import { getLawPolicy, getLawPolicyMeta, getLawPublicEndpoints, listLawPolicies, searchLawPolicies, } from "../../law.js";
import { formatLawDiscover, formatLawPolicyFull, formatLawPolicyMeta, formatLawPolicyList, } from "./law-format.js";
function resolveLawAction(raw) {
 ...
 */
export const lawTool = {
    name: "law_query",
    description: "Query public JEXXXUS legal policies on law.jexxx.us (Terms of Service, Privacy Policy, " +
    ...
    async execute(args) {
        ...
        switch (action) {
            ...
            case "meta": {
                ...
                if (!meta)
                    return `No Law policy found matching "${key}".`;
...
//# sourceMappingURL=law-tools.js.map
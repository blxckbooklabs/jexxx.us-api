export const BLXCKCHAT_HOTKEYS = [
    ...
    { keys: "Shift+↑↓ / Ctrl+↑↓", action: "Scroll chat history by line (from input)", source: "opencode" },
    { keys: "Scrollbar ▌ (mouse)", action: "Click/drag chat history (default on)", source: "blxckchat" },
    { keys: "PgUp / PgDn", action: "Scroll history by half viewport (Ctrl+B focus)", source: "opencode" },
    { keys: "Ctrl+Alt+U / D", action: "Scroll history by quarter viewport", source: "opencode" },
    ...
    { keys: "Ctrl+L", action: "Model picker (/model)", source: "pi" },
    { keys: "/provider", action: "Switch profile or add provider (BYOK)", source: "blxckchat" },
    ...
    { keys: "Ctrl+Y", action: "Copy full TUI snapshot (chrome digest + visual)", source: "blxckchat" },
    { keys: "Ctrl+Shift+Y", action: "Copy chrome digest only (model, auth, tools, hints)", source: "blxckchat" },
    ...
    { keys: "← / →", action: "Move cursor · Shift+arrow select by character", source: "blxckchat" },
    { keys: "Option+← / →", action: "Move by word · Option+Shift select word", source: "blxckchat" },
    { keys: "Cmd+← / →", action: "Jump to line start / end · Cmd+Shift select to line edge", source: "blxckchat" },
    { keys: "Home / End", action: "Jump to line start / end (transmit box)", source: "blxckchat" },
    { keys: "Double-click word", action: "Select word (Google Docs style)", source: "blxckchat" },
...
export function formatHotkeysOverlay() {

 ...
 */
export function formatStreamingChunk(buffer) {
    if (!buffer.trim()) {
...
export function finalizeStreamedContent(raw) {
    if (!raw.trim()) {
        return "";
    }
 ...
 */
export async function streamTokens(fullResponse, onUpdate, chunkSize = 1, delayMs = 0) {

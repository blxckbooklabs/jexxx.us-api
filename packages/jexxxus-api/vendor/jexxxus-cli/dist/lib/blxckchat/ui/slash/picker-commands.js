...
export function isPickerSlashCommand(commandName) {
 ...
 */
export function shouldSuppressSlashArgumentSuggestions(commandName, argFilter) {
    return isPickerSlashCommand(commandName) && !argFilter.trim();
}
//# sourceMappingURL=picker-commands.js.map
...
import { deleteCredentials, formatAuthStatusLines, loadCredentials, refreshAccessTokenViaServer, saveCredentials, } from "../../auth.js";
import { DeviceLoginCancelledError, } from "./components/device-login-overlay.js";
import { THEME } from "./theme.js";
export function promptBlessedYesNo(screen, message) {
...
export function createAuthTuiActions(options) {
    ...
    return {
        ...
        async logout() {
            ...
            const ok = await promptBlessedYesNo(screen, "Revoke CLI access and delete stored credentials?");
            if (!ok) {
...
//# sourceMappingURL=auth-tui.js.map
...
function buildAuthPickerItems(creds) {
    if (!creds) {
        return [
            {
                id: "login",
...
export function createAuthPickerOverlay(screen, opts) {
...
//# sourceMappingURL=auth-picker-overlay.js.map
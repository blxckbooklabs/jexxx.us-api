...
export function stripOrphanParenLines(text) {
    return text
        .split("\n")
...
export function stripSpacedLetterGarbageLines(text) {
    return text
        .split("\n")
        .filter((line) => {
...
export function sanitizeRoleplayProse(text) {
    let out = stripOrphanParenLines(text);
    out = stripSpacedLetterGarbageLines(out);
    return out.replace(/\n{3,}/g, "\n\n").trimEnd();
}
//# sourceMappingURL=prose-sanitize.js.map
...
import { isBlessedMouseEnabled, isSlashPopupMouseEnabled, } from "../lib/blxckchat/ui/tty.js";
const prior = process.env.BLXCKCHAT_MOUSE;
afterEach(() => {
    if (prior === undefined)
        delete process.env.BLXCKCHAT_MOUSE;
    else
        process.env.BLXCKCHAT_MOUSE = prior;
});
...
//# sourceMappingURL=blxckchat-tty-mouse.test.js.map
...
import { halfPageScrollDelta, isNearBottom, lineScrollStep, pageScrollDelta, restoreScrollOffset, scrollPercent, scrollPercentAfterContent, } from "../lib/blxckchat/ui/components/scroll-state.js";
...
test("lineScrollStep defaults to 1 and honors BLXCKCHAT_SCROLL_LINES", () => {
    ...
    if (prev === undefined)
        ...
        process.env.BLXCKCHAT_SCROLL_LINES = prev;
});
//# sourceMappingURL=blxckchat-scroll-state.test.js.map
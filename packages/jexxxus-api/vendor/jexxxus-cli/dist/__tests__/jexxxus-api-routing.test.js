...
test("getJexxxusApiBaseUrl defaults to live API when unset", () => {
    ...
    try {
        ...
        if (prevUrl === undefined)
            ...
            process.env.JEXXXUS_API_URL = prevUrl;
        if (prevFlag === undefined)
            delete process.env.JEXXXUS_ACCOUNT_API;
        else
            process.env.JEXXXUS_ACCOUNT_API = prevFlag;
    }
});
test("getJexxxusApiBaseUrl respects JEXXXUS_API_URL override", () => {
    ...
    try {
        ...
        if (prev === undefined)
            ...
            process.env.JEXXXUS_API_URL = prev;
    }
});
test("getJexxxusApiBaseUrl returns null when JEXXXUS_ACCOUNT_API=off", () => {
    ...
    try {
        ...
        if (prev === undefined)
            ...
            process.env.JEXXXUS_ACCOUNT_API = prev;
    }
});
//# sourceMappingURL=jexxxus-api-routing.test.js.map
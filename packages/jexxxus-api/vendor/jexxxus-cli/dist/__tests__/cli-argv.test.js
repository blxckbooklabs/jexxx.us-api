...
function userArgsFromProcessArgv(argv) {
    return argv.slice(2);
}
...
test("node argv preserves subcommands and prompts", () => {
    assert.deepEqual(userArgsFromProcessArgv(["/usr/bin/node", "/opt/jexxxus/dist/index.js", "doctor"]), ["doctor"]);
    assert.deepEqual(userArgsFromProcessArgv([
        "/usr/bin/node",
...
//# sourceMappingURL=cli-argv.test.js.map
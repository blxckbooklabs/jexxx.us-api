...
import { getTvPublicEndpoints, getTvVideo, getTvVideoMeta, listTvCategories, listTvVideos, parseTvLlmsFullText, parseTvLlmsText, parseTvRssFeed, resetTvRemoteCacheForTests, searchTvVideos, slugifyTv, } from "../lib/tv.js";
...
test("assertAllowedTvPublicBaseUrl permits tv.jexxx.us", () => {
    assert.equal(assertAllowedTvPublicBaseUrl("https://tv.jexxx.us/"), "https://tv.jexxx.us");
});
test("assertAllowedTvPublicBaseUrl blocks internal SSRF hosts", () => {
    assert.throws(() => assertAllowedTvPublicBaseUrl("https://169.254.169.254/"), /not allowed/i);
});
...
//# sourceMappingURL=tv.test.js.map
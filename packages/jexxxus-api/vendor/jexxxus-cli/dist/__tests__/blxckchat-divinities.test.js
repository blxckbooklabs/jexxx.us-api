...
import { extractPersonaPrompt, parsePersonaMetadata, } from "../lib/blxckchat/divinities/prompt.js";
import { clearDivinityPersonaCache, findDivinityPersona, listDivinityPersonas, } from "../lib/blxckchat/divinities/source.js";
import { activateDivinityPersona, clearActiveDivinity, } from "../lib/blxckchat/divinities/session.js";
...
const FIXTURE_ROOT = path.join(process.cwd(), "src", "__tests__", "fixtures", "divinities");
...
afterEach(() => {
    if (priorVault === undefined)
        ...
        process.env.DIVINITIES_VAULT_PATH = priorVault;
    if (priorObsidian === undefined)
        delete process.env.JEXXXUS_OBSIDIAN_PERSONAS_PATH;
    else
        process.env.JEXXXUS_OBSIDIAN_PERSONAS_PATH = priorObsidian;
...
test("listDivinityPersonas auto-discovers monorepo jexxx.us-obsidian/Divinities", () => {
    ...
    delete process.env.JEXXXUS_OBSIDIAN_PERSONAS_PATH;
    clearDivinityPersonaCache();
    const monorepoPersonas = path.join(process.cwd(), "..", "jexxx.us-obsidian", "Divinities", "Personas");
...
//# sourceMappingURL=blxckchat-divinities.test.js.map
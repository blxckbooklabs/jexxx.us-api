...
import { compactKingdomBulletLinks, extractKingdomUrlsFromText, repairMarkdownUrlBlobs, sanitizeKingdomUrls, splitGluedKingdomUrls, } from "../lib/blxckchat/kingdom-url-sanitize.js";
const TV_CATALOG = [
    {
        surface: "tv",
...
test("sanitizeKingdomUrls fixes wv host and spaced slugs", () => {
    const broken = "🎬 Watch: SEXY Nanny [https://wv.jexxx.us/video/sexy-na ny-gets-fir d-so-she-needs-the-extra-cash]";
...
test("splitGluedKingdomUrls separates concatenated VEIL links", () => {
    const glued = "https://veil.jexxx.us/articles/10-christian-excuses-that-actually-mean-come-fuck-me-after-servicehttps://veil.jexxx.us/articles/why-pastor-s-wives-make-the-best-sluts-a-deep-theological-filthy-breakdown";
...
test("repairMarkdownUrlBlobs expands bracketed glued URLs to bullets", () => {
    const input = "[https://veil.jexxx.us/articles/one\nhttps://veil.jexxx.us/articles/two]";
...
test("compactKingdomBulletLinks converts Title [url] to markdown links", () => {
    const input = "• I Turned a Rachel Into a Leah [https://veil.jexxx.us/articles/i-turned-a-rachel-into-a-leah]";
...
test("sanitizeKingdomUrls strips a fully invented VEIL URL when the catalog is empty", () => {
    const fabricated = 'Read: [The Weight of Silence](https://veil.jexxx.us/articles/the-weight-of-silence)';
...
test("sanitizeKingdomUrls still repairs a real catalog URL when other fabricated ones are present", () => {
    const mixed = "Real: https://veil.jexxx.us/articles/10-christian-excuses-that-actually-mean-come-fuck-me-after-service\n" +
...
//# sourceMappingURL=kingdom-url-sanitize.test.js.map
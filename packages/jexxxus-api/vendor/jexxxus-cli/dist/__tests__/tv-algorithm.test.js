...
import { calculateDevotionScore, heavyRankerShuffle, recommendTvVideos, } from "../lib/tv-algorithm.js";
...
test("heavyRankerShuffle returns every video exactly once", () => {
    const videos = Array.from({ length: 20 }, (_, i) => video({ slug: `video-${i}`, views: i * 10 }));
...
//# sourceMappingURL=tv-algorithm.test.js.map
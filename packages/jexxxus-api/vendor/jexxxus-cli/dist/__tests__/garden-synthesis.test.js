...
import { collectGardenToolResultsSinceUser, needsGardenSynthesis, stripMetaContinuationPrompts, } from "../lib/blxckchat/garden-synthesis.js";
test("stripMetaContinuationPrompts removes want-the-scene tails", () => {
    const raw = "She heads for the door.\n\nWant the scene to continue? I can bring the pastor's daughter in.";
...
test("needsGardenSynthesis false when verse and veil linked", () => {
    ...
    const reply = "Hannah prayed bitterly — *She was in bitterness of soul* — and handed her the [Excuses](https://veil.jexxx.us/articles/sample) piece.";
...
//# sourceMappingURL=garden-synthesis.test.js.map